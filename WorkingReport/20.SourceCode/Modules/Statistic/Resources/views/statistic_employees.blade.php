...
@section('title', 'Thống kê theo nhân viên')
              ...
              <div class="widget">
                ...
                <div class="widget-body">
                  <!--<form id="registrationForm" method="post" class="" data-bv-message="This value is not valid">-->
                                ...
                                <div class="col-lg-9">
                                    <select id="block" class="form-control">
                                        ...
                                        @foreach($block as $option)
                                            <option value="{{$option->id}}">{{$option->block_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                    ...
                    <div id="data-area">
                    @if(!empty($data))
                    @include('statistic::statistic_data')
                    @endif
                    </div>
                </div>
              </div>
        ...
        $('#submit').click(function () {
            //if (!start_date) {
                ...
                if (flag) {
                    $.ajax({
                        type: 'post',
                        url: '{{route("Statistic.search-data")}}',
                        data: {
