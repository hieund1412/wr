...
<div class="widget">
    ...
    <div class="widget-body">
        <form action="{{ route('users.update',$data->id) }}" method="post" id="editUser"
            ...
            @csrf
            <input type="hidden" id="id_check" value="{{ $data->id }}">
            <div class="row">
                <div class="col-md-5">
                    <div class="form-group" style="margin-top: 5%">
                        ...
                        <input type="text" class="form-control"
                               ...
                               name="user_login" value="{{ $data->user_login }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="block_id" id="block" class="form-control" data-bv-notempty="true"
                            ...
                            @foreach($block as $item)
                                <option value="{{ $item->id }}" {{ ($item->id == $data->block_id) ? 'selected' : '' }}>{{ $item->block_name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select name="department_id" id="department" class="form-control" data-bv-notempty="true"
                            ...
                            @foreach($depart as $item)
                                <option value="{{ $item->id }}" {{ ($item->id == $data->department_id) ? 'selected' : '' }}>{{ $item->department_name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group" style="margin-top: 5%">
                        ...
                        <select name="role_id" id="role_id" class="form-control" data-bv-notempty="true"
                            ...
                            @foreach($role as $item)
                                <option value="{{ $item->id }}" {{ ($item->id == $data->role_id) ? 'selected' : ''  }}>{{ $item->role_name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select name="permission" id="permission" class="form-control" data-bv-notempty="true"
                            ...
                            @foreach($permission as $item)
                                <option value="{{ $item->id }}" {{ ($item->id == $data->permission) ? 'selected' : '' }}>{{ $item->permission_name }}</option>
                            @endforeach
                        </select>
