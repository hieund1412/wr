        ...
        return f.Client.prototype = {
            ...
            TableTools.prototype = {
                fnGetSelected: function (n) {
                    ...
                    var r = [], u = this.s.dt.aoData, f = this.s.dt.aiDisplay, t, i;
                    if (n) for (t = 0, i = f.length; t < i; t++) u[f[t]]._DTTT_selected && r.push(f[t]); else for (t = 0, i = u.length; t < i; t++) u[t]._DTTT_selected && r.push(t);
                    return r
                    ...
                    var a = this, v = n(i).offset(), f = u._collection, y = v.left, s = v.top + n(i).outerHeight(),
                        p = n(t).height(), h = n(r).height(), w = n(t).width(), o = n(r).width(), e, c, l;
                    ...
                    if (this.s.master) {
                        ...
                        n(i.nTBody).on("click.DTTT_Select", this.s.custom.sRowSelector, function (r) {
                            var u = this.nodeName.toLowerCase() === "tr" ? this : n(this).parents("tr")[0],
                                e = t.s.select, s = t.s.dt.oInstance.fnGetPosition(u), c;
                            if (u.parentNode == i.nTBody && i.oInstance.fnGetData(u) !== null) {
                                if (e.type == "os") if (r.ctrlKey || r.metaKey) t.fnIsSelected(u) ? t._fnRowDeselect(u, r) : t._fnRowSelect(u, r); else if (r.shiftKey) {
                                    var f = t.s.dt.aiDisplay.slice(), o = n.inArray(e.lastRow, f), h = n.inArray(s, f);
                                ...
                                } else t.fnIsSelected(u) && t.fnGetSelected().length === 1 ? t._fnRowDeselect(u, r) : (t.fnSelectNone(), t._fnRowSelect(u, r)); else t.fnIsSelected(u) ? t._fnRowDeselect(u, r) : e.type == "single" ? (t.fnSelectNone(), t._fnRowSelect(u, r)) : e.type == "multi" && t._fnRowSelect(u, r);
                                e.lastRow = s
                            }
                        });
                    ...
                    var u = [], o = this.s.dt, i, r, e = o.aoColumns, f = e.length, s;
                    if (typeof t == "function") for (s = t.call(this, o), i = 0, r = f; i < r; i++) u.push(n.inArray(i, s) !== -1 ? !0 : !1); else if (typeof t == "object") {
                        for (i = 0, r = f; i < r; i++) u.push(!1);
                        for (i = 0, r = t.length; i < r; i++) u[t[i]] = !0
                    } else if (t == "visible") for (i = 0, r = f; i < r; i++) u.push(e[i].bVisible ? !0 : !1); else if (t == "hidden") for (i = 0, r = f; i < r; i++) u.push(e[i].bVisible ? !1 : !0); else if (t == "sortable") for (i = 0, r = f; i < r; i++) u.push(e[i].bSortable ? !0 : !1); else for (i = 0, r = f; i < r; i++) u.push(!0);
                    return u
                }, _fnNewline: function (n) {
                    return n.sNewLine == "auto" ? navigator.userAgent.match(/Windows/) ? "\r\n" : "\n" : n.sNewLine
                }, _fnGetDataTablesData: function (t) {
                    var r, o, s, k, e, h = [], i = "", y, f = this.s.dt, p, a = new RegExp(t.sFieldBoundary, "g"),
                        w = this._fnColumnTargets(t.mColumns),
                        v = typeof t.bSelectedOnly != "undefined" ? t.bSelectedOnly : !1, c, b, l;
                    if (t.bHeader) {
                    ...
                    var t = this.s.dt, f = t.nScrollHead.getElementsByTagName("div")[0],
            ...
            TableTools._fnEventListen = function (n, t, i) {
                TableTools._aListeners.push({that: n, type: t, fn: i})
            };
            ...
            typeof n.fn.dataTable == "function" && typeof n.fn.dataTableExt.fnVersionCheck == "function" && n.fn.dataTableExt.fnVersionCheck("1.9.0") ? n.fn.dataTableExt.aoFeatures.push({
                fnInit: function (n) {
                    var t = n.oInit, i = t ? t.tableTools || t.oTableTools || {} : {};
