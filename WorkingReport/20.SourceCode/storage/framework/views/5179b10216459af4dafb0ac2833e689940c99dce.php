<?php $__env->startSection('title', 'Sửa đổi người dùng'); ?>
...
<div class="widget">
    <div class="widget-header ">
        <span class="widget-caption">Sửa đổi người dùng</span>
    ...
    <div class="widget-body">
        <form action="<?php echo e(route('users.update',$data->id)); ?>" method="post" id="editUser"
            ...
            <?php echo csrf_field(); ?>
            <input type="hidden" id="id_check" value="<?php echo e($data->id); ?>">
            <div class="row">
                <div class="col-md-5">
                    <div class="form-group" style="margin-top: 5%">
                        ...
                        <input type="text" class="form-control"
                               id="recipient-name-depart" disabled
                               name="user_login" value="<?php echo e($data->user_login); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="full-name" class="col-lg-4 col-form-label">Họ tên <span style="color:red">*</span> :</label>
                        <div class="col-lg-8">
                        <input type="text" class="form-control"
                               id="full-name"
                               name="fullname" value="<?php echo e($data->fullname); ?>"
                    ...
                    <div class="form-group">
                        ...
                        <select name="block_id" id="block" class="form-control" data-bv-notempty="true"
                            ...
                            <?php $__currentLoopData = $block; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($item->id); ?>" <?php echo e(($item->id == $data->block_id) ? 'selected' : ''); ?>><?php echo e($item->block_name); ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <select name="department_id" id="department" class="form-control" data-bv-notempty="true"
                            ...
                            <?php $__currentLoopData = $depart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($item->id); ?>" <?php echo e(($item->id == $data->department_id) ? 'selected' : ''); ?>><?php echo e($item->department_name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                ...
                <div class="col-md-5">
                    <div class="form-group" style="margin-top: 5%">
                        <label for="message-text" class="col-lg-4 col-form-label">Vai trò <span style="color:red">*</span> :</label>
                        <div class="col-lg-8">
                        <select name="role_id" id="role_id" class="form-control" data-bv-notempty="true"
                                data-bv-notempty-message="Vai trò không được để trống">
                            <option selected="selected" value="">---Chọn Vai trò---</option>
                            <?php $__currentLoopData = $role; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($item->id); ?>" <?php echo e(($item->id == $data->role_id) ? 'selected' : ''); ?>><?php echo e($item->role_name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select name="permission" id="permission" class="form-control" data-bv-notempty="true"
                            ...
                            <?php $__currentLoopData = $permission; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($item->id); ?>" <?php echo e(($item->id == $data->permission) ? 'selected' : ''); ?>><?php echo e($item->permission_name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    ...
                    <div class="form-group">
                        <label for="recipient-name-departs" class="col-lg-4 col-form-label">Email <span style="color:red">*</span> :</label>
                        <div class="col-lg-8">
                        <input type="text" class="form-control"
            ...
            <div class="modal-footer" >
                <div align="center" >
                <button type="button" onclick="validate()" class="btn btn-info btn-fill btn-wd" style="margin-right:5%;">Sửa đổi</button>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\WorkingReport\20.SourceCode\Modules\Users\Providers/../Resources/views/form_edit.blade.php ENDPATH**/ ?>