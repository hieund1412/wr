<?php $__env->startSection('title', 'Quản lý công việc theo ngày'); ?>
...
<div class="widget">
    ...
    <div class="widget-body">
                        ...
                        <div class="col-lg-9" >
                            <div class=" input-group">
                                ...
                                <input type="text" class="form-control date-picker" id="from_date" data-date-format="dd/mm/yyyy"
                                       value="<?php echo e(\Carbon\Carbon::now()->subDays(7)->format('d/m/Y')); ?>">
        ...
        <div id="table_workflow">
            <?php echo $__env->make('workflow::tableWorkflow', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
</div>
</div>
...
<?php $__env->startSection('js'); ?>
    <script>
        ...
        $('#block').change(function () {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo e(route('workflow.ajax-get-data')); ?>',
        ...
        $('#search').click(function () {
            ...
            if (from_date != "" && to_date != "" && block != "") {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo e(route('workflow.ajax')); ?>',
                    data: {
                        fullname: fullname,
                        from_date: from_date,
                        to_date: to_date,
        ...
        function clickSave(col) {
            // $('.save').on('click', function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo e(route('workflow.edit')); ?>',
                    dataType: "json",
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DaoTao\WorkingReport\trunk\20.SourceCode\Modules\Workflow\Providers/../Resources/views/viewWorkflow.blade.php ENDPATH**/ ?>